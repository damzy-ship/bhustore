...
const SingleCategory = ({products, status, catName}) => {
            ...
            <div className='container'>
                <div className='cat-single-content'>
                    <div className='section-title'>
                        <h3 className='text-uppercase fw-7 text-regal-blue ls-1'>{catName}</h3>
                    </div>
                            ...
                            products.map(product => (
                                <div className='product-item bg-white' key = {product.id} onClick = {() => viewModalHandler(product)}>
                                    ...
                                    <ImageContainer className='product-item-img-container' img={product.images[0]} alt="" />
                                        <div className = "product-item-cat text-white fs-13 text-uppercase bg-gold fw-6">{catName}</div>
                                    </div>
